[CmdletBinding()]
param(
    [ValidateSet("hatch", "hatch-full", "hatch-hunt", "hatch-filter-test", "hatch-sort-test", "hatch-parent-test", "hatch-attack-test", "hatch-hp-test", "hatch-stage-hatch", "hatch-stage-attack", "hatch-stage-hp", "hatch-stage-top", "hatch-stage-mass", "hatch-stage-collect", "hatch-stage-cave")]
